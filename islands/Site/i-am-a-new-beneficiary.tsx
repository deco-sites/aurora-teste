          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-12">
            ...
            <div className="lg:w-3/4 flex flex-col gap-4">
              {segments[activeSegment.value].topics.map((
                ...
                <div
                  onClick={(event) => handleClickExpandIcon(index, event)}
                  ...
                  >
                    <span
                      className={`text-gray11 ${
                        activeTopic.value === index ? "block" : "hidden"
                      }`}
                      dangerouslySetInnerHTML={{
                    ...
                    {topic.hasTable && <TableTopic topic={topic} />}
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="lg:w-1/4 flex flex-col pt-8 lg:sticky lg:top-8 lg:h-full">
              {segments.map((segment, index) => (
                <div
                  ...
                  onClick={(event) => handleClickExpandSection(index, event)}
                >
                  ...
                  <div
                    className={`${
                      mobileActiveSegment.value === index ? "flex" : "hidden"
                    } flex-col gap-4 pb-6`}
                  >
                    {segment.topics
                      .map((
