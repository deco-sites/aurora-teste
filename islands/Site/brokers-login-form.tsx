...
export default function BrokersLoginFormIsland() {
            ...
            >
              ...
              <div className="flex flex-col lg:flex-row justify-between items-center pt-11 gap-8 lg:gap-0">
                <div className="flex gap-3">
                  <button className="rounded-full border border-pink2 text-pink2 text-sm px-8 py-3">
                    Esqueceu sua senha?
                  </button>
