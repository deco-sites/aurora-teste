            ...
            <div className="hidden lg:flex gap-3 whitespace-nowrap">
              <a
                ...
                className={`relative font-bold ${
                  option?.name === "prestador" ? "text-orange1" : "text-white"
                } ${
                  colors[
                    option.color
                  ]
              ...
              >
                ...
                >
                  <div
                    className={`w-full h-full ${backgroundColors[option.id]}`}
                    style={{
              ...
              {orderedOptions.map((headerOption, index) => (
                <a
                  ...
                  className={` ${colors[headerOption?.textColor]} ${
                    colors[
                      headerOption.color
                    ]
