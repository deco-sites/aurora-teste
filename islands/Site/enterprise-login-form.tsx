...
export default function EnterpriseLoginFormIsland() {
      ...
      <div className="flex justify-center px-10 lg:px-0 bg-white">
        <div className="lg:max-w-[1400px] w-full pt-12 pb-16">
          <div className="flex flex-col lg:px-44 gap-10">
            <span className="font-sora font-bold text-darkPurple text-2xl">
              Faça login<br /> como empresa
            </span>
            <form
            ...
            >
              ...
              <div className="flex flex-col lg:flex-row justify-between items-center pt-11 gap-8 lg:gap-0">
                ...
                <button className="flex justify-center items-center gap-3 px-20 text-sm py-4 bg-darkPurple rounded-full text-white">
                  Entrar
                  <Image
