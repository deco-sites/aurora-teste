        ...
        <div className="lg:max-w-[1400px] w-full pt-12 pb-16 lg:py-32 lg:px-32">
          <div className="mb-14 flex flex-col px-8 gap-5 lg:gap-0 lg:flex-row lg:items-center justify-between lg:px-14 lg:pb-16 lg:border-b border-b-black border-opacity-15 ">
            ...
            <div className="flex flex-col gap-4 lg:max-w-[500px] text-black text-opacity-50">
              <span>
                Você, médico, clínica ou laboratório, é apaixonado por cuidar da
                saúde das pessoas? Aqui, na Aurora Saúde, acreditamos que a
                colaboração é a chave para promover o bem-estar.
              </span>
              <span>
                Convidamos você a se tornar um prestador credenciado e fazer
                parte da nossa rede de cuidados de qualidade. Junte-se a nós na
                missão de oferecer atendimento excepcional e acessível a mais
                pessoas.
              </span>
              <span>
                Esse pode ser o começo de uma jornada conosco para cuidar e
                estar junto de quem mais precisa!
              </span>
            </div>
          </div>
