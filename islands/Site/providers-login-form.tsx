...
export default function ProvidersLoginFormIsland() {
      ...
      <div className="flex justify-center px-10 lg:px-0 bg-white">
        <div className="lg:max-w-[1400px] w-full pt-12 pb-16">
          <div className="flex flex-col lg:px-44 gap-10">
            <span className="font-sora font-bold text-pink2 text-2xl">
              Faça login como<br /> prestador
            </span>
            <form
            ...
            >
              <div className="flex flex-col gap-5 pb-10 border-b border-b-gray12">
                <div
                  className={`flex items-center rounded-full px-2 py-3 w-full ${
                    errors.login ? "border border-red" : "bg-gray4"
                  }`}
                >
                ...
                <div
                  className={`flex items-center rounded-full px-2 py-3 w-full ${
                    errors.password ? "border border-red" : "bg-gray4"
                  }`}
                >
                  <svg className="w-5 h-5 text-gray-400 ml-6">
              ...
              <div className="flex flex-col lg:flex-row justify-end items-center pt-11 gap-8 lg:gap-0">
                {
                  /*
                ...
                <button className="flex justify-center items-center gap-3 px-20 text-sm py-4 bg-pink2 rounded-full text-white">
                  Entrar
                  <Image
