      ...
      >
        <div className="flex flex-col lg:flex-row items-center text-black text-opacity-40 text-xs font-sora">
          <div className="hidden lg:block">
            <span>
              A Aurora Saúde utiliza cookies essenciais para possibilitar
              o<br /> bom funcionamento do site e pode coletar dados de<br />
              {" "}
              navegação para melhorar a sua experiência em nossas<br />{" "}
          ...
          <div className="flex flex-col items-center lg:hidden">
            <span className="text-justify ">
              A Aurora Saúde utiliza cookies essenciais para possibilitar o bom
              funcionamento do site e pode coletar dados de navegação para
              melhorar a sua experiência em nossas plataformas de conteúdos e
              serviços.
            </span>
            <a
              href="/politicas-de-privacidade"
