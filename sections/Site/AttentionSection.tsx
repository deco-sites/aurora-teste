        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-28">
          ...
          <div className="">
            <span className="text-white font-sora text-lg lg:text-base">
              As funcionalidades do APP e Portal só serão liberadas depois
              que<br /> você preencher o questionário da Jornada de Saúde!
              <br />
              <br />
              Depois de concluído, é só fazer o login novamente que todos
              os<br /> nossos serviços estarão liberados para você.
            </span>
          </div>
        </div>
      </div>
