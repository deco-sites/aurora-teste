          ...
          <div className="lg:w-1/3 pl-14 flex flex-col gap-5 font-sora">
            <span
              ...
              dangerouslySetInnerHTML={{
                __html: device === "desktop" ? desktopTitle : mobileTitle,
              }}
            >
            </span>
            <span className="text-yellow text-lg">
              No APP Aurora Saúde, disponível para Android e IOS, e no Portal do
              Beneficiário, que fica aqui no nosso site, você encontra tudo que
              precisa para cuidar da sua saúde.
            </span>
          </div>
