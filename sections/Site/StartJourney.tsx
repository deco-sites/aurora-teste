  ...
  return (
    ...
    >
      <div className="lg:w-1/2">
        <div className="flex flex-col gap-10 pt-14 px-14 pb-40 lg:pt-36 lg:pb-32 lg:pl-64 lg:pr-48">
          ...
          <span className="text-orange1">
            É por isso que, na Aurora, acompanhamos a sua rotina e seus hábitos
            diários para garantir o seu bem-estar antes mesmo de qualquer doença
            aparecer. Isso significa que não esperamos os problemas surgirem,
            cuidamos de você desde o primeiro momento.
            <br />
            <br />
            Aqui o cuidado com a sua saúde é integral, humano e individual.
            Legal, né? Agora é hora de colocar tudo isso em prática!
          </span>
          <a href="http://app.marsaude.net/aurora/login" target="_blank">
            <button className="text-pink1 lg:text-yellow bg-white lg:bg-orange1 rounded-full lg:w-fit py-6 px-10 flex justify-between lg:gap-10 w-full">
              Iniciar Jornada
              <Icon
                className={`h-auto ${device === "desktop" ? "" : "-rotate-90"}`}
                id={`${
                  device === "desktop" ? "YellowArrowUp" : "PinkArrowDown"
                }`}
                strokeWidth={1}
                size={20}
              />
      ...
      <div className="relative lg:w-1/2">
        ...
        />
        <Image
          src={"/Site/care-journey-seal2.png"}
          alt={"Banner"}
