...
export default function A500DetailsModal(
  ...
  return (
    <>
      <div
        className={`fixed top-0 left-0 flex min-h-screen w-screen bg-yellow justify-center items-start lg:items-center overflow-x-hidden overflow-y-scroll max-h-full pb-8`}
        style={{
          ...style,
